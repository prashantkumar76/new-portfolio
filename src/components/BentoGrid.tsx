...
export const BentoCard = ({
    ...
    return (
        ...
        >
            ...
            <div className="pointer-events-none z-10 flex transform-gpu flex-col gap-1 p-6 transition-all duration-300 group-hover:-translate-y-10">
                {Icon && (
                    typeof Icon === 'function' ? (
                        ...
                        <div className="h-12 w-12 origin-left transform-gpu text-muted-foreground transition-all duration-300 ease-in-out group-hover:scale-75">
                            {Icon}
                        </div>
                    )
                )}
            ...
            >
                <span className="pointer-events-auto cursor-pointer text-sm font-medium text-primary hover:underline">
                    {cta}
                </span>
            </div>
